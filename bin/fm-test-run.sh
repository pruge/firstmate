...
family_for_basename() {
  case "$1" in
    ...
    fm-transition-lib.test.sh|fm-ticket-check.test.sh|\
    ...
    fm-secondmate-wake-stall.test.sh|fm-watch-triage.test.sh|fm-task-inbox.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 34279
tests/fm-afk-pi-herdr-return-e2e.test.sh 71
tests/fm-afk-return.test.sh 1654
tests/fm-ask-user-authority.test.sh 88
tests/fm-backend-cmux-smoke.test.sh 32
tests/fm-backend-cmux.test.sh 3578
tests/fm-backend-herdr-focus-flash-e2e.test.sh 20
tests/fm-backend-orca.test.sh 17169
tests/fm-backend-tmux-smoke.test.sh 338
tests/fm-backend-zellij-smoke.test.sh 21
tests/fm-backend-zellij.test.sh 8271
tests/fm-backend.test.sh 17853
tests/fm-backlog-handoff.test.sh 49551
tests/fm-bearings-board.test.sh 3449
tests/fm-bearings-snapshot.test.sh 74432
tests/fm-bootstrap-network-parallel.test.sh 8068
tests/fm-bootstrap.test.sh 35159
tests/fm-branch-supervision.test.sh 5192
tests/fm-busy-adapter-wiring.test.sh 14967
tests/fm-busy-state.test.sh 2906
tests/fm-calm-pi-extension.test.sh 237
tests/fm-classify-decision-key.test.sh 934
tests/fm-claude-stop-autoarm-live-e2e.test.sh 19
tests/fm-claude-stop-autoarm.test.sh 60676
...
tests/fm-consult.test.sh 1899
tests/fm-control-relaunch.test.sh 62293
tests/fm-control.test.sh 37069
tests/fm-cursor-harness.test.sh 30071
tests/fm-cursor-primary-live-e2e.test.sh 20
tests/fm-cursor-primary.test.sh 48560
tests/fm-daemon.test.sh 16828
tests/fm-documentation-audiences.test.sh 660
tests/fm-fleet-snapshot-view.test.sh 7602
tests/fm-fleet-sync.test.sh 36936
tests/fm-gate-refuse.test.sh 4227
tests/fm-gitignore-config.test.sh 57
tests/fm-gotmp.test.sh 815
tests/fm-grok-continuity-live-e2e.test.sh 20
tests/fm-grok-stop-live-e2e.test.sh 20
tests/fm-guard-stale-banner.test.sh 10760
tests/fm-harness-liveness-drift-live-e2e.test.sh 19
tests/fm-herdr-session-cleanup.test.sh 6303
tests/fm-herdr-submit-confirm-live-e2e.test.sh 20
tests/fm-herdr-version-floor-live-e2e.test.sh 23
tests/fm-inactive-reconcile.test.sh 41313
tests/fm-kimi-harness.test.sh 14687
tests/fm-lint-workflows.test.sh 835
tests/fm-muse-harness.test.sh 43925
tests/fm-muse-signals-live-e2e.test.sh 23
tests/fm-on.test.sh 8384
tests/fm-opencode-primary-live-e2e.test.sh 20
tests/fm-operational-input.test.sh 214
tests/fm-peek-remote.test.sh 927
tests/fm-pending-reply.test.sh 21717
tests/fm-pi-branch-extension.test.sh 10208
tests/fm-pi-branch-live-e2e.test.sh 19
tests/fm-pi-primary-live-e2e.test.sh 20
tests/fm-pi-watch-extension.test.sh 40230
tests/fm-pr-check-security.test.sh 235902
...
tests/fm-remote-doctor.test.sh 4892
tests/fm-remote-entrypoint.test.sh 99
tests/fm-remote-job-orphan-reap.test.sh 2938
tests/fm-remote-job.test.sh 52464
tests/fm-remote-reply.test.sh 84245
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 168934
tests/fm-remote-secondmate-parent-binding.test.sh 13230
tests/fm-remote-secondmate-trace-context.test.sh 42230
tests/fm-secondmate-harness.test.sh 137752
tests/fm-secondmate-wake-stall.test.sh 24063
tests/fm-secondmate-lifecycle-e2e.test.sh 7058
tests/fm-secondmate-liveness.test.sh 8457
tests/fm-secondmate-safety.test.sh 50765
tests/fm-secondmate-sync.test.sh 15824
tests/fm-send-inbox-doorbell-live-e2e.test.sh 21
tests/fm-send-inbox.test.sh 37953
tests/fm-send-remote-delivery.test.sh 14276
tests/fm-send-resolve-key.test.sh 17464
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 73
tests/fm-send-secondmate-marker.test.sh 5938
tests/fm-session-lock-ancestry.test.sh 1208
tests/fm-session-start.test.sh 144883
tests/fm-sessionstart-hook-live-e2e.test.sh 19
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 24
tests/fm-sessionstart-nudge.test.sh 28495
tests/fm-shared-captain-inheritance.test.sh 5332
tests/fm-spawn-dispatch-profile.test.sh 58101
tests/fm-spawn-pool-base-freshen.test.sh 13295
tests/fm-spawn-worktree-settle.test.sh 4841
tests/fm-startup-memory-budget.test.sh 6795
tests/fm-startup-network.test.sh 49975
tests/fm-stow-cascade.test.sh 2969
tests/fm-subagent-pretool-check.test.sh 1047
tests/fm-supervision-events.test.sh 587
tests/fm-tangle-guard.test.sh 8484
tests/fm-task-delivery.test.sh 2425
tests/fm-task-inbox.test.sh 29670
tests/fm-teardown-endpoint-safety.test.sh 3715
tests/fm-teardown.test.sh 92037
tests/fm-test-fixture-cleanup.test.sh 539
tests/fm-test-isolation-proof.test.sh 465
tests/fm-tmux-agent-liveness.test.sh 1553
tests/fm-tool-update-check.test.sh 13107
tests/fm-trace-context-lib.test.sh 206
tests/fm-trace-context-spawn.test.sh 34674
tests/fm-turnend-guard.test.sh 18594
tests/fm-update.test.sh 5008
tests/fm-vendor-auth-probe.test.sh 43218
tests/fm-voice-relay.test.sh 28636
tests/fm-wake-daemon-lifecycle-e2e.test.sh 6467
tests/fm-wake-drain-open-decisions-cursor.test.sh 19325
tests/fm-wake-drain-open-decisions.test.sh 5351
tests/fm-wake-drain-unread-status.test.sh 10517
tests/fm-wake-queue.test.sh 44002
tests/fm-watch-arm.test.sh 73142
tests/fm-watch-checkpoint.test.sh 5616
tests/fm-watch-recovery-loop.test.sh 58753
tests/fm-watch-triage.test.sh 145934
tests/fm-watcher-lock.test.sh 71471
EOF
}
