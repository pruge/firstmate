...
cp "$ROOT/.pi/extensions/fm-edit-recovery.ts" "$TMP_ROOT/fm-edit-recovery.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-edit-xml-recovery.ts" "$TMP_ROOT/lib/fm-edit-xml-recovery.ts"
